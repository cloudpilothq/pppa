...
const jsonLd = {
  ...
  author: { '@type': 'Organization', name: 'DSPPPPA Delta State' },
  publisher: { '@type': 'Organization', name: 'DSPPPPA Delta State', url: BASE_URL },
  url: `${BASE_URL}/blog/${POST.slug}`,
};
    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 border border-slate-200">
          <p className="text-sm font-semibold text-slate-700 mb-2">Also useful:</p>
          <ul className="space-y-1">
            <li><Link href="/blog/how-to-spot-land-fraud-in-delta-state" className="text-blue-700 hover:underline text-sm font-medium">→ How to Spot Land Fraud in Delta State</Link></li>
            <li><Link href="/blog/how-to-verify-land-ownership-before-buying-in-delta-state" className="text-blue-700 hover:underline text-sm font-medium">→ How to Verify Land Ownership Before Buying</Link></li>
            <li><Link href="/blog/certificate-of-occupancy-the-most-important-land-document-in-delta-state" className="text-blue-700 hover:underline text-sm font-medium">→ Certificate of Occupancy: The Most Important Land Document</Link></li>
          </ul>
        </div>
        <div className="mt-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-4">Need Legal Assistance on Property Matters?</h3>
          <p className="text-blue-100 max-w-2xl mx-auto mb-8">Contact the DSPPPPA Legal Directorate for guidance on property documentation, dispute resolution, and enforcement actions in Delta State.</p>
          <Link href="/contact" className="bg-white text-blue-700 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-slate-50 transition-all hover:-translate-y-1 inline-block">Contact Us</Link>
        </div>
