...
export const metadata: Metadata = { title: `${POST.title} | DSPPPPA Blog`, description: POST.excerpt };
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="relative w-full aspect-[16/9] md:aspect-[2/1] rounded-3xl overflow-hidden mb-16 shadow-2xl border border-slate-100">
        ...
        <div className="mt-16 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          ...
          <p className="text-emerald-100 max-w-2xl mx-auto mb-8">If your property rights have been violated, report it to us. We are mandated by law to investigate and take action to protect you.</p>
          <Link href="/report" className="bg-white text-emerald-700 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-slate-50 transition-all hover:-translate-y-1 inline-block">Report a Violation</Link>
        </div>
      </article>
    </div>
  );
