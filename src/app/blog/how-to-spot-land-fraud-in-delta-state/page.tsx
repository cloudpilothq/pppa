    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-4">Suspect a Land Fraud in Delta State?</h3>
          <p className="text-emerald-100 max-w-2xl mx-auto mb-8">Report fraudulent property transactions to the DSPPPPA immediately. Our Legal Directorate is ready to investigate and take swift action.</p>
