    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 border border-slate-200">
          <p className="text-sm font-semibold text-slate-700 mb-2">Also important for developers:</p>
          <ul className="space-y-1">
            ...
            <li><Link href="/news/asaba-waterfront-city-govt-warns-against-illegal-structures" className="text-emerald-700 hover:underline text-sm font-medium">→ News: Asaba Waterfront City — Govt Warns Against Illegal Structures</Link></li>
          </ul>
        </div>
        <div className="mt-12 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-4">Starting a Construction Project?</h3>
          <p className="text-emerald-100 max-w-2xl mx-auto mb-8">Contact the DSPPPPA for guidance on the correct development approval process before breaking ground in Delta State.</p>
