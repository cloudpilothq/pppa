  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-16 bg-gradient-to-br from-red-600 to-red-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-4">Being Harassed for Illegal Levies?</h3>
          <p className="text-red-100 max-w-2xl mx-auto mb-8">
            Do not pay. Report any illegal demand for development levies to the DSPPPPA immediately. We will deploy officers to your site and prosecute the offenders.
          </p>
          <Link href="/report" className="bg-white text-red-700 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-slate-50 transition-all hover:-translate-y-1 inline-block">
