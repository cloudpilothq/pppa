      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 border border-slate-200">
          ...
          <ul className="space-y-1">
            <li><Link href="/blog/understanding-the-land-use-act-1978-and-its-impact-on-delta-state" className="text-blue-700 hover:underline text-sm font-medium">→ Understanding the Land Use Act 1978</Link></li>
            <li><Link href="/news/delta-state-commits-to-enforcing-anti-deve-law" className="text-blue-700 hover:underline text-sm font-medium">→ News: Delta State Commits to Enforcing Anti-Deve Law</Link></li>
          </ul>
        </div>
