    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 border border-slate-200">
          <p className="text-sm font-semibold text-slate-700 mb-2">Related legal guides:</p>
          <ul className="space-y-1">
            <li><Link href="/blog/common-property-disputes-in-delta-state-and-how-to-resolve-them" className="text-emerald-700 hover:underline text-sm font-medium">→ Common Property Disputes and How to Resolve Them</Link></li>
        ...
        <div className="mt-12 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          ...
          <p className="text-emerald-100 max-w-2xl mx-auto mb-8">The DSPPPPA Legal Directorate can refer you to verified legal practitioners specializing in estate administration and property law in Delta State.</p>
