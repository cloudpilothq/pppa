    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <article className="container mx-auto px-4 max-w-4xl pt-12">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 border border-slate-200">
          <p className="text-sm font-semibold text-slate-700 mb-2">Understand the legal context:</p>
        ...
        <div className="mt-12 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-4">Is Your Land at Risk?</h3>
          <p className="text-emerald-100 max-w-2xl mx-auto mb-8">Contact the DSPPPPA to report illegal occupations and recover state-owned or private property in Delta State.</p>
          <Link href="/report" className="bg-white text-emerald-700 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-slate-50 transition-all hover:-translate-y-1 inline-block">Report a Case</Link>
        </div>
      </article>
    </div>
  );
