      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <div key={idx} className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 hover:border-emerald-500 hover:shadow-lg transition-all group flex flex-col">
              ...
              <Link href={`/services/${service.slug}`} className="mt-6 text-emerald-600 font-semibold text-sm hover:underline inline-flex items-center">
                Learn More →
              </Link>
            </div>
          ))}
        ...
        <div className="mt-20 bg-slate-900 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
          ...
          <div className="relative z-10">
            ...
            <Link href="/contact" className="inline-block bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold py-4 px-10 rounded-lg transition-all hover:scale-105 shadow-lg shadow-emerald-500/25">
