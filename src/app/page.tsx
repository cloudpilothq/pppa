          ...
          <div className="max-w-5xl mx-auto bg-transparent rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-6">
                <span className="bg-red-100 text-red-700 text-xl font-bold px-6 py-3 rounded-full border border-red-200 inline-flex items-center gap-2">
                  <span className="relative flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-3 w-3 bg-red-500"></span>
                  </span>
                  DELTA STATE PEOPLE, UNA DON HEAR?
                </span>
              </div>
