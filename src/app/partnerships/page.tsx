    ...
    <div className="bg-background min-h-screen py-16">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center justify-center p-3 mb-6 bg-emerald-100 rounded-full text-emerald-600">
        ...
        <div className="bg-slate-900 rounded-2xl p-8 md:p-16 text-center text-white relative overflow-hidden">
           ...
           <button className="bg-emerald-500 hover:bg-emerald-400 text-white font-bold py-4 px-10 rounded-lg transition-colors relative z-10">
